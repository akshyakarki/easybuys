                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="date" value="{{$deal['start_date']}}" name="start_date" required
                                           class="form-control">
                                </div>
                                <div class="col-md-6">
                                    <label for="name">{{ trans('messages.end_date')}}</label>
                                    <input type="date" value="{{$deal['end_date']}}" name="end_date" required
                                           class="form-control">
                                </div>
                            </div>
...
{{--<div class="col-md-12" style="padding-top: 20px">
                                ...
                                <div class="col-md-12 pt-3">
                                    <center>
                                        <img width="500" height="200" onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'" src="{{asset('storage/app/public/deal')}}/{{$deal['banner']}}">
                                    </center>
                                </div>
                                <div class="col-md-12" style="padding-top: 20px">
                                    <center>
